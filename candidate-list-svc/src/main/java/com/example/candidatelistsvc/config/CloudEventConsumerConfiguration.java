...
import com.example.candidatelistsvc.domain.exception.ConsumerNonRetryableException;
import com.example.candidatelistsvc.endpoint.messaging.consumer.CloudEventConsumer;
