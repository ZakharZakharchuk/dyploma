...
import static com.example.candidatelistsvc.endpoint.messaging.dto.EventTypes.PERSON_DELETED;
...
public class PersonDeletedConsumer extends AbstractCloudEventConsumer<PersonDeletedData>
    ...
    public PersonDeletedConsumer(@Qualifier("cloudEventMapper") ObjectMapper cloudEventMapper,
          Validator validator, SelectionEntryService selectionEntryService) {
        super(cloudEventMapper, validator);
        this.selectionEntryService = selectionEntryService;
    }
    ...
    public void accept(CloudEventDto cloudEventDto) {
        ...
        selectionEntryService.deleteByCandidateId(personDeletedData.getPersonId());
    }
